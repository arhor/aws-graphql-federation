...
@AnalyzeClasses(packagesOf = [SchedulerServiceRunner::class], importOptions = [DoNotIncludeTests::class])
class ApplicationArchitectureTest {
    ...
    fun `should check that correct layered architecture is observed`(
        ...
        val appRootPackage = SchedulerServiceRunner::class.java.getPackage().name
