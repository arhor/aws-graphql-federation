...
sealed class PostBatchLoader(
    ...
    private val loader: Function<Set<String>, Map<String, List<Post>>>,
) : MappedBatchLoader<String, List<Post>> {

    override fun load(keys: Set<String>): CompletableFuture<Map<String, List<Post>>> {
