...
interface UserRepresentationService {
     ...
     * @param idempotentKey the UUID used to ensure idempotency of the creation operation
     */
     ...
     * @param idempotentKey the UUID used to ensure idempotency of the deletion operation
     */
