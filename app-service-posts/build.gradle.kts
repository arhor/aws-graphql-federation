...
tasks {
    ...
    generateJava {
        language = "kotlin"
        packageName = "com.github.arhor.dgs.posts.generated.graphql"
    }
    ...
    classDirectories.setFrom(
        files(
            classDirectories.files.map {
                fileTree(it) {
                    exclude(
                        "com/github/arhor/dgs/posts/**/Main*.class",
                        "com/github/arhor/dgs/posts/**/aop/",
                        "com/github/arhor/dgs/posts/**/config/",
                        "com/github/arhor/dgs/posts/**/generated/",
                    )
                }
            }
        )
